<template>
    <main class="mt-3">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div id="carouselExampleIndicators" class="carousel caousel-dark slide" data-bs-ride="carousel">
                        <ol class="crousel-indicators">
                        ...
                        <div class="carousel-inner">
                            <div :class="`carousel-item ${i==0?'active':''}`" :key="i" v-for="(pimg, i) in productImage">
                                <img :src="`download/${productId}/${pimg.path}`" alt="" class="d-block">
                            </div>
                        </div>
                        <a href="#carouselExampleIndivators" class="carousel-control-prev" role="button" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </a>
                        <a href="#carouselExampleIndivators" class="carousel-control-next" role="button" data-bs-slide="next">
