<template>
    <main class="mt-3">
        <div class="container">
            ...
            <div class="mb-3 row">
                <label for="" class="col-md-3 col-form-label">제품가격</label>
                <div class="col-md-9">
            ...
            <div class="mb-3 row">
                <label for="" class="col-md-3 col-form-label">배송비</label>
                <div class="col-md-9">
                    <div class="input-group mb-3">
            ...
            <div class="mb-3 row">
                <label for="" class="col-md-3 col-form-label">추가배송비(도서산간)</label>
                <div class="col-md-9">
                    <div class="input-group mb-3">
            ...
            <div class="mb-3 row">
                <label for="" class="col-md-3 col-form-label">제품카테고리</label>
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-auto">
            ...
            <div class="mb-3 row">
                <label for="" class="col-md-3 col-form-label">태그</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" v-model="product.tag">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="" class="col-md-3 col-form-label">출고일</label>
                <div class="col-md-9">
                    <div class="input-group mb-3">
