...
* 문자세트에 따라 바이트가 달라진다.
* 'A는 반각, 한은 전각'
* EUC-KR 문자수는 12 바이트는 19
* UTF-8  문자수는 12 바이트는 26
**************************************************/
...
* 날짜의 덧셈과 뺄셈
* 시스템 날짜의 1일 후를 계산하기
* INTERVAL 1 DAY는 1일 후 라는 기간형 상수
* 기간형 상수는 DB마다 다르므로 확인(표준지정X)
**************************************************/
SELECT CURRENT_DATE + INTERVAL 1 DAY;

/**************************************************
* 날짜형 간의 뺄셈
* '2020-02-01'-'2020-01-01' 날짜차이 계산
* MYSQL은 DATEDIFF('2020-02-01'-'2020-01-01')로
* 계산 가능
**************************************************/
...
/**************************************************
* CASE를 사용할 경우 주의사항
* SELECT WHERE ORDER BY 등 어디에나 사용가능
* ELSE를 생략하면 NULL이 되므로 가급적 생략하지 않는것이 좋다.
**************************************************/